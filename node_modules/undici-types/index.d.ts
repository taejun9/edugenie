...
export { Agent, BalancedPool, Client, DecoratorHandler, Dispatcher, EnvHttpProxyAgent, MockAgent, MockClient, MockPool, Pool, ProxyAgent, RedirectHandler, RetryAgent, RetryHandler, buildConnector, connect, errors, getGlobalDispatcher, getGlobalOrigin, interceptors, mockErrors, pipeline, request, setGlobalDispatcher, setGlobalOrigin, stream, upgrade }
